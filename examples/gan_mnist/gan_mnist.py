...
from Collagen.collagen.models import DCGAN
...
if __name__ == "__main__":
    ...
    for fold_id, (x_train, x_val) in enumerate(FoldSplit(train_ds, random_state=args.seed)):
        ...
        # optimizer_d = torch.optim.Adam(params=model.get_module_by_name("D").parameters(), lr=args.lr, weight_decay=args.wd)
        # optimizer_g = torch.optim.Adam(params=model.get_module_by_name("G").parameters(), lr=args.lr,
