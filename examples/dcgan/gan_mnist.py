...
from collagen.metrics import RunningAverageMeter, Meter
...
class ProgressbarCallback(Callback):
    ...
    def on_batch_end(self, strategy: GANStrategy, epoch: int, progress_bar: tqdm,
                     callbacks: Iterable[Callback or Meter], **kwargs):
        self.__count += 1
        if self._check_freq():
            list_metrics_desc = []
...
if __name__ == "__main__":
    ...
    item_loaders['real_train'] = ItemLoader(meta_data=train_ds,
