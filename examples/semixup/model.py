...
class DawnNet(nn.Module):
    def __init__(self, in_channels=3, n_features=64, drop_rate=0.2, n_classes=10):
        ...
        self.linear = nn.Linear(2 * c[3], n_classes, bias=True)
...
class MBConvBlock(nn.Module):
    ...
    def __init__(self, block_args, global_params):
        ...
        oup = self._block_args.input_filters * self._block_args.expand_ratio  # number of x channels
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        # Stem
        in_channels = 3  # rgb
        out_channels = round_filters(32, self._global_params)  # number of x channels
        ...
        for block_args in self._blocks_args:
            ...
            # Update block input and x filters based on depth multiplier.
        ...
        # Head
        in_channels = block_args.output_filters  # x of final block
    ...
    def extract_features(self, inputs):
        """ Returns x of the final convolution layer """
